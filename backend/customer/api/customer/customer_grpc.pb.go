...
const (
	Customer_GetCaptcha_FullMethodName = "/api.customer.Customer/GetCaptcha"
)
...
func (c *customerClient) GetCaptcha(ctx context.Context, in *GetCaptchaRequest, opts ...grpc.CallOption) (*GetCaptchaReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCaptchaReply)
	err := c.cc.Invoke(ctx, Customer_GetCaptcha_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCustomerServer) GetCaptcha(context.Context, *GetCaptchaRequest) (*GetCaptchaReply, error) {
...
func _Customer_GetCaptcha_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCaptchaRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CustomerServer).GetCaptcha(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Customer_GetCaptcha_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServer).GetCaptcha(ctx, req.(*GetCaptchaRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Customer_GetCaptcha_Handler,
		},
	},
